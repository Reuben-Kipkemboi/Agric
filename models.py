...
class AppCustomer(models.Model):
    ...
    customer_id = models.ForeignKey('AppUser', models.DO_NOTHING, blank=True, null=True)
...
class AppFeedback(models.Model):
    ...
    machinery_id = models.ForeignKey('AppMachinery', models.DO_NOTHING, blank=True, null=True)
...
class AppMachinery(models.Model):
    id = models.BigAutoField(primary_key=True)
    image = models.CharField(max_length=255, blank=True, null=True)
    machinery_properties = models.TextField(blank=True, null=True)
    machinery_name = models.CharField(max_length=50, blank=True, null=True)
    ...
    ploughing_pay_rate = models.IntegerField()
    planting_pay_rate = models.IntegerField()
    forklifting_pay_rate = models.IntegerField()
    transport_pay_rate = models.IntegerField()
    operator_name = models.CharField(max_length=50, blank=True, null=True)
    owner_id = models.ForeignKey('AppUser', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'app_machinery'
...
class AppOwnerPost(models.Model):
    id = models.BigAutoField(primary_key=True)
    machinery_name = models.CharField(max_length=100, blank=True, null=True)
    machinery_image = models.CharField(max_length=255)
